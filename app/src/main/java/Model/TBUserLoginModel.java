...
public class TBUserLoginModel {
    ...
    public static String getUlUserLoginId() {
        return ulUserLoginId;
    }

    public static void setUlUserLoginId(String ulUserLoginId) {
        TBUserLoginModel.ulUserLoginId = ulUserLoginId;
    }
    ...
    public static void setUlName(String ulName) {
        TBUserLoginModel.ulName = ulName;
    }
